...
const ContactNavbar = () => {
  ...
  <img src="/images/logo1.png" alt="KiteCare Logo" className="logo-image" />
      ...
      <div className="navbar-help-text1">
        <h1>Specialist Consultations for Every Need</h1>
      </div>

      <div className="navbar-event-details1">
        <p>Our highly experienced team of doctors, surgeons, transplant surgeons, physicians, critical care and emergency medicine specialists, nursing and support staff across all specialities provide personalized care and comprehensive treatment.</p>
      </div>
      <div className="bottom-iconsspl">
        <Link to="/events" className="info-itemspl">
          <div className="icon-circlespl">
            <FontAwesomeIcon icon={faCalendarAlt} />
          </div>
          <span>Events</span>
        </Link>
        <Link to="/contact-us" className="info-itemspl">
          <div className="icon-circlespl">
            <FontAwesomeIcon icon={faPhone} />
          </div>
          <span>Contact Us</span>
        </Link>
        <Link to="/about" className="info-itemspl">
          <div className="icon-circlespl">
            <FontAwesomeIcon icon={faInfoCircle} />
          </div>
          <span>About</span>
        </Link>
        <Link to="/health-information" className="info-itemspl">
          <div className="icon-circlespl">
