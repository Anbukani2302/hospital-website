...
const ContactNavbar = () => {
  ...
  <img src="/images/logo1.png" alt="KiteCare Logo" className="logo-image" />
      ...
      <div className="navbar-event-details">
        <p>Stay tuned to all the events happening at Kite Care Surandai.</p>
      </div>
      <div className="bottom-icons2">
        <Link to="/events" className="info-item2">
          <div className="icon-circle2">
            <FontAwesomeIcon icon={faCalendarAlt} />
          </div>
          <span>Events</span>
        </Link>
        <Link to="/contact-us" className="info-item2">
          <div className="icon-circle2">
            <FontAwesomeIcon icon={faPhone} />
          </div>
          <span>Contact Us</span>
        </Link>
        <Link to="/about" className="info-item2">
          <div className="icon-circle2">
            <FontAwesomeIcon icon={faInfoCircle} />
          </div>
          <span>About</span>
        </Link>
        <Link to="/health-information" className="info-item2">
          <div className="icon-circle2">
