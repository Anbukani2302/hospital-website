...
const AboutNavbar = () => {
  ...
  <img src="/images/logo1.png" alt="KiteCare Logo" className="logo-image" />
      ...
      {/* Help and Event Text */}
      <div className="navbar-help-text12">
      <h1>Explore Our Comprehensive Health Services</h1>
      </div>

      <div className="navbar-event-details12">
      <p>Discover a wide range of healthcare services designed to meet your needs. From consultations to treatments, KiteCare is here to provide the best care possible.</p>
       ...
       {/* Bottom Icons */}
       <div className="bottom-iconsabout">
        <Link to="/events" className="info-itemabout">
          <div className="icon-circleabout">
            <FontAwesomeIcon icon={faCalendarAlt} />
          </div>
          <span>Events</span>
        </Link>
        <Link to="/contact-us" className="info-itemabout">
          <div className="icon-circleabout">
            <FontAwesomeIcon icon={faPhone} />
          </div>
          <span>Contact Us</span>
        </Link>
        <Link to="/about" className="info-itemabout">
          <div className="icon-circleabout">
            <FontAwesomeIcon icon={faInfoCircle} />
          </div>
          <span>About</span>
        </Link>
        <Link to="/health-information" className="info-itemabout">
          <div className="icon-circleabout">
